...
cuint8_t constSenseModeModeOffset       =
        ISC10;    //!< 010 Interromper o deslocamento de posição do bit de modo de sentido
cuint8_t constSenseModeMask             = 0x03;     //!< 100 Interrupt sense mode bit mask
